...
//        }
        ...
        /* ------------------------- new carousel speeds ------------------------- */
        if (dpadUpHit1) carouselSpeed = 0.95;
        if (dpadDownHit1) carouselSpeed = 0.875;
        ...
        if (a1) {
            spinner.setPower(-carouselSpeed * spinDirection);
        } else {
            spinner.setPower(0);
        }
        ...
        telemetry.addData("carousel speed", carouselSpeed);
