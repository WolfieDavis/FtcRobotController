...
public class freightDrive3 extends OpMode {
    ...
    minLinearPos = 0.9525, //0.635 = .25" //0.375 //the btm position of the outake (how far down it will go)
            maxLinearPos = 34.625,//13.625" //13.6875 total    //15.875 - the top position of the outake (how far up it will go)
            linearDownPos = 0, //the pick stuff up position
            linearUpPos = maxLinearPos - minLinearPos, //the dump high position
            linearStagedPos = 5, //2" //the ready to pick up position (but still have clearance)
            linearLowPos = 7.62, //3" //the bottom dump pos
            linearMidPos = 20.32, //8" //the dump low position
